        ...
        <form action="">
            <div class="r_content_area">
                ...
                <section class="r_info">
                    ...
                    <textarea type="text" placeholder="예)김치찌개 끓이기"></textarea>
                    ...
                    <textarea type="text" placeholder="이 레시피에 관련된 소개를 적어주세요"></textarea>
                    <div class="r_txt">동영상</div>
                    <textarea type="text" class="video cf" placeholder="레시피와 관련된 youtube 동영상이 있을 시 링크를 입력해주세요"></textarea>
                    <div class="r_in_video">
                        동영상 썸네일<br>
                        <i class="fa-solid fa-video"></i>   
                    </div>
                    <div class="r_txt">카테고리</div>
                    <select name="r_in_category" id="r_in_category">
                    ...
                    <div class="r_in_num">
                        ...
                        <select name="r_in_num" id="r_in_num">
                    ...
                    <select name="r_in_time" id="r_in_time">
                    ...
                    <div class="r_in_lev">
                        ...
                        <select name="r_in_lev" id="r_in_lev">
                ...
                <section class="r_ing_container ">
                    <div class="r_ing flex_area_rsb">
                        ...
                        <div class="ing_category">
                            <input type="text" placeholder="재료"><br>
                        ...
                        <div class="r_ing_content">
                            <div class="ing_name_amount">
                                <div class="ing_input_area">
                                    <input type="text" placeholder="예)돼지고기">
                                    <input type="text" placeholder="예)300g">  
                                </div>
                                
                                
                                <div class="ing_input_area">
                                    <input type="text" placeholder="예)양배추">
                                    <input type="text" placeholder="예)1/2개">  
                                    <div class="btn_del">
                                        <button type="button">
                                ...
                                <div class="ing_input_area">
                                    <input type="text" placeholder="예)참기름">
                                    <input type="text" placeholder="예)1T">
                                    <div class="btn_del">
                                        <button type="button">
                                            <i class="fa-solid fa-circle-xmark"></i>
                                        </button>
                                ...
                                <div class="ing_input_area">
                                    <input type="text" placeholder="예)소금">
                                    <input type="text" placeholder="예)2t">
                                    <div class="btn_del">
                                        <button type="button" >
                                            <i class="fa-solid fa-circle-xmark"></i>
                                        </button>
                ...
                <section class="r_seq">
                    <div class="seq_content_area flex_area_rsb">
                        ...
                        <h2>Step1</h2>
                        <textarea name="" id="" cols="30" rows="10" placeholder="예)소고기는 기름기를 떼어내고 적당한 크기로 썰어주세요."></textarea>
                        <div class="seq_step_pho seq_step_pho1">
                            <label for="inq_file_step1">
                                <div class="file_upload_btn">
                                    <i class="fa-solid fa-plus"></i>
                                </div>
                            </label>
                            <input type="file" data-ax-path="file" name="inq_file_step1" id="inq_file_step1" multiple="multiple"> 
                        </div>
                ...
                <section class="r_ect flex_area_rsb">
                    ...
                    <textarea name="" id="" cols="30" rows="10" placeholder="예)고기요리에는 소금보다 설탕을 먼저 넣어야 단맛이 겉돌지 않고 육질이 부드러워요"></textarea>
                </section>
                <div class="textline"></div>
                <!--[e]기타 영역 -->
