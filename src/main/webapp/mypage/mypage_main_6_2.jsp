                ...
                <div class="inq_list">
                    <div class="inq_select">
                        <ul class="inq_s">
                            <li>
                                <div class="inq_class">
                                    <ul class="inq_menu">
                                        <li class="board_all menu_li active"><a class="active_a" href="#">전체</a></li>
                    ...
                    <div class="my_inq_list">
                        <table class="inq_list_tb">
                            ...
                            <tbody>
                                <tr>
                                    <td class="inq_n"><a href="#">1</a></td>
                                    <td id="inq_bd" class="inq_board">쇼핑</td>
                                    <td class="inq_title"><a href="#">쇼핑 문의1</a></td>
                                    <td class="inq_date"><a href="#">23.04.08</a></td>
                                    <td class="inq_status">답변 대기중</td>
                                </tr>
                                <tr>
                                    <td class="inq_n"><a href="#">2</a></td>
                                    <td id="inq_bd" class="inq_board">커뮤니티</td>
                                    <td class="inq_title"><a href="mypage_main_6_2_view.html">커뮤니티 문의1</a></td>
                                    <td class="inq_date"><a href="#">23.04.12</a></td>
                                    <td class="inq_status">답변 완료</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    <button class="inquering btn_c">문의하기</button>
