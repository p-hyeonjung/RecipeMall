            ...
            <div class="mypage_content">
                ...
                <form id="join_form" action="join.jsp" method="post">
                    ...
                    <p>
                        ...
                        <input type="button" class="btn_userjoin" value="중복 확인" onclick="">
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        <input type="text" id="user_addr1" name="user_addr">
                        <input type="button" class="btn_useraddr" value="주소 검색" onclick="">
                        <input type="text" id="user_addr2" name="user_addr" placeholder="세부주소쓰기 ex)123동 456호">
                    </p>
                    <p>
                ...
                <button class="btn_cancel"><a href="mypage.html">취소</a></button>
            </div>
            <!-- mypage_content -->
        </div>
    </div>
